...
/*
Now let's see the our volume growth By pulling overall session and order volume, 
...
/*
I’d like to show how we’ve grown specific channels by pulling a quarterly view of orders 
...
/*
Now let's analyse monthly trending for revenue 
...
/*
Let’s dive deeper into the impact of introducing new products. Let's get monthly sessions to 
...
-- first we identify all the views of the /products page
